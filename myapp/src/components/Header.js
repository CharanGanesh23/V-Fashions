        ...
        <div className='max-w-screen-xl h-full mx-auto flex items-center justify-between'>
            ...
            <div className='flex items-center gap-8'>
                <ul className='flex items-center gap-8'>
                    <li className='text-base text-black font-bold hover:text-orange-900 hover:underline underline-offset-2 decoration-[1px] cursor-pointer duration-300 ' href="Homepage.js">Home</li>
                ...
                <div className='relative'>
                    <img src={cartImg} className='w-6' ></img>
                    <span className='absolute w-6 top-2 left-0 text-sm flex items-center justify-center font-semibold font font-titleFont'>{productData.length}</span>
                </div>
